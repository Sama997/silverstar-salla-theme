    ...
    plugins: [
        ...
        new CopyPlugin({
            patterns: [
                ...
                {from: asset('videos'), to: public('videos'), noErrorOnMissing: true},
                {from: asset('styles/silverstar.css'), to: public('styles/silverstar.css')},
                {from: asset('js/silverstar.js'), to: public('js/silverstar.js')},
            ]
        }),
    ],
    optimization: {
